  ...
  <div className="flex h-[100vh] w-[100vw]">
    ...
    {clicked && clickedID === "Exercises" && 
      ...
      <div className="h-[100vh] w-[100vw]  bg-green-900 absolute top-0 z-50">
        ...
        <div onClick={handleExit} className="bg-red-600 absolute right-[3%] top-[3%] h-10 w-10 rounded-4xl content-center place-items-center hover:cursor-pointer"><p>X</p></div>
          <div onClick={()=>navigate("/lessons/animals/lesson2/activity1")} className="bg-amber-400 hover:cursor-pointer  h-[255px] w-[255px] flex justify-center place-items-center text-4xl">Activity1</div>
          <div onClick={()=>navigate("/lessons/animals/lesson2/activity2")} className="bg-fuchsia-700 hover:cursor-pointer h-[255px] w-[255px] flex justify-center place-items-center"><p className="text-4xl">Activity2</p></div>
